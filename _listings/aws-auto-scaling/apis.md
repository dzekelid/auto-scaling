...
- name: AWS Auto Scaling API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/auto-scaling/master/_listings/aws-auto-scaling/action-describeautoscalingnotificationtypes-get.md
x-common:
- type: x-articles
